...
power30 = power_calc(length, width, efficiency, coefficient, global_ir_30, tcell)
tcell = pvlib.temperature.sapm_cell(global_ir_35, temp, wind, **temp_params)
power35 = power_calc(length, width, efficiency, coefficient, global_ir_35, tcell)
tcell = pvlib.temperature.sapm_cell(global_ir_40, temp, wind, **temp_params)
power40 = power_calc(length, width, efficiency, coefficient, global_ir_40, tcell)
